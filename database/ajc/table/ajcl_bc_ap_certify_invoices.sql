  ...
  CREATE TABLE "AJC"."AJCL_BC_AP_CERTIFY_INVOICES" 
 ...
 LOB ("JSON_DATA_RESPONSE") STORE AS BASICFILE (
  ...
  CREATE INDEX "AJC"."AJCL_BC_CERTIFY_STATUS_I2" ON "AJC"."AJCL_BC_AP_CERTIFY_INVOICES" ("STATUS") 
  ...
  CREATE INDEX "AJC"."AJCL_BC_CERTIFY_C_I4" ON "AJC"."AJCL_BC_AP_CERTIFY_INVOICES" ("COMPANY") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE INDEX "AJC"."AJCL_BC_CERTIFY_IID_I3" ON "AJC"."AJCL_BC_AP_CERTIFY_INVOICES" ("INVOICE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE INDEX "AJC"."AJCL_BC_CERTIFY_RID_I1" ON "AJC"."AJCL_BC_AP_CERTIFY_INVOICES" ("REQUEST_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE OR REPLACE EDITIONABLE SYNONYM "APPS_ORAFSYS"."AJCL_BC_AP_CERTIFY_INVOICES" FOR "AJC"."AJCL_BC_AP_CERTIFY_INVOICES"
