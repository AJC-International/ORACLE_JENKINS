  ...
  CREATE TABLE "AJC"."AJCL_BC_AP_TRV_TPAY_INVOICES" 
 ...
 LOB ("JSON_DATA_RESPONSE") STORE AS BASICFILE (
  ...
  CREATE INDEX "AJC"."AJCL_BC_TRV_TPAY_C_I4" ON "AJC"."AJCL_BC_AP_TRV_TPAY_INVOICES" ("COMPANY") 
  ...
  CREATE INDEX "AJC"."AJCL_BC_TRV_TPAY_IID_I3" ON "AJC"."AJCL_BC_AP_TRV_TPAY_INVOICES" ("INVOICE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE INDEX "AJC"."AJCL_BC_TRV_TPAY_RID_I1" ON "AJC"."AJCL_BC_AP_TRV_TPAY_INVOICES" ("REQUEST_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE INDEX "AJC"."AJCL_BC_TRV_TPAY_STATUS_I2" ON "AJC"."AJCL_BC_AP_TRV_TPAY_INVOICES" ("STATUS") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE OR REPLACE EDITIONABLE SYNONYM "APPS_ORAFSYS"."AJCL_BC_AP_TRV_TPAY_INVOICES" FOR "AJC"."AJCL_BC_AP_TRV_TPAY_INVOICES"
