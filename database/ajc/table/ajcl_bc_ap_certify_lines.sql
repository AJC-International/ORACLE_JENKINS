  ...
  CREATE TABLE "AJC"."AJCL_BC_AP_CERTIFY_LINES" 
 ...
 LOB ("JSON_DATA_RESPONSE") STORE AS BASICFILE (
  ...
  CREATE INDEX "AJC"."AJCL_BC_CERTIFYL_IID_I3" ON "AJC"."AJCL_BC_AP_CERTIFY_LINES" ("INVOICE_ID") 
  ...
  CREATE INDEX "AJC"."AJCL_BC_CERTIFYL_LN_I4" ON "AJC"."AJCL_BC_AP_CERTIFY_LINES" ("LINE_NUMBER") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE INDEX "AJC"."AJCL_BC_CERTIFYL_RID_I1" ON "AJC"."AJCL_BC_AP_CERTIFY_LINES" ("REQUEST_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE INDEX "AJC"."AJCL_BC_CERTIFYL_STATUS_I2" ON "AJC"."AJCL_BC_AP_CERTIFY_LINES" ("STATUS") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  ...
  CREATE OR REPLACE EDITIONABLE SYNONYM "APPS_ORAFSYS"."AJCL_BC_AP_CERTIFY_LINES" FOR "AJC"."AJCL_BC_AP_CERTIFY_LINES"
