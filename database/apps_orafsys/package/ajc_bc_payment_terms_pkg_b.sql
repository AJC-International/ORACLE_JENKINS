CREATE OR REPLACE PACKAGE BODY ajc_bc_payment_terms_pkg IS
  ...
  BEGIN
    ...
    print_log ('ajc_bc_payment_terms_pkg.get_payment_terms_p (+)');
  ...
  BEGIN
    ...
    print_log ('ajc_bc_payment_terms_pkg.process_payment_terms_p (+)');
    ...
    -- Queda comentado porque en el web service no existe el campo systemModifiedBy
      ...
      BEGIN
        ...
        */
        ...
        ELSE
          ...
          -- 20240202 v_tbl_status := 'NOT EXIST';
        ...
        BEGIN
          ...
          -- Se verifica si existe en AR y se obtienen los valores actuales
          ...
          SELECT term_id,
                 ...
                 NVL(cpt.type,attribute1), -- Si de BC trae valor, se usa ese valor, sino se deja el que tiene
  ...
  BEGIN
    ...
    print_log ('ajc_bc_payment_terms_pkg.main_p (+)');



    v_email := ajc_bc_ws_utils_pkg.get_emails_f ( 'PAYMENT TERMS' );
    ...
    IF ( v_payment_terms_count > 0 ) THEN
      ...
      v_request_id_excel := ajc_bc_ws_utils_pkg.print_excel_report ( p_request_id => gv_request_id,
                                                                     ...
                                                                     p_program => 'AJCBCPTIR', -- AJC BC Payment Terms Interface Report

                                                                     p_template => 'AJCBCPTIR' );
  ...
  BEGIN
    ...
    v_request_id := fnd_request.submit_request ( 'XXAJC',
                                                 ...
                                                 'AJCBCPTI', -- AJC BC Payment Terms Interface
    ...
    IF v_request_id = 0 THEN
      ...
      print_log('Error Ejecutando FND_REQUEST.SUBMIT_REQUEST. AJCBCPTI - AJC BC Payment Terms Interface. Error: ' || v_message || ', ' || SQLERRM);
    ...
    IF NOT fnd_concurrent.wait_for_request ( v_request_id,
      ...
      print_log('Error Ejecutando FND_REQUEST.WAIT_FOR_REQUEST. AJCBCPTI - AJC BC Payment Terms Interface, con nro. solicitud ' || 
    ...
    IF v_conc_dev_phase != 'COMPLETE' OR v_conc_dev_status != 'NORMAL' THEN
      ...
      print_log('Error en la ejecucion del concurrente AJCBCPTI - AJC BC Payment Terms Interface, con nro. solicitud ' || 
