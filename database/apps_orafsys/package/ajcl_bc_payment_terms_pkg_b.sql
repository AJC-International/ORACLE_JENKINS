CREATE OR REPLACE PACKAGE BODY ajcl_bc_payment_terms_pkg IS
...
-- Creation: SBANCHIERI 23-AUG-2023
  ...
  BEGIN
    ...
    print_log ('ajcl_bc_payment_terms_pkg.process_payment_terms_p (+)');
  ...
  BEGIN
    ...
    gv_company_id := p_company_id;

    gv_company_name := p_company_id;    



    print_log ('ajcl_bc_payment_terms_pkg.main_p (+)');
