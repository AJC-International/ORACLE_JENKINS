CREATE OR REPLACE PACKAGE BODY ajc_bc_gl_balances_pkg IS
  ...
  BEGIN
    ...
    print_log ('ajc_bc_gl_balances_pkg.get_period_year (+)' );
  ...
  EXCEPTION 
    ...
    WHEN OTHERS THEN
      ...
      print_log ('ajc_bc_gl_balances_pkg.translated_ending_balance (!). Error: ' || SQLERRM );
      ...
      FROM ( SELECT company,
                    ...
                    CASE 
                      ...
                      ELSE
                        ...
                        ajc_bc_gl_balances_pkg.translated_ending_balance ( p_set_of_books_id => set_of_books_id,
               ...
               FROM ( SELECT -- ORACLE
                             ...
                             ajc_bc_atis_batch_interface_pk.get_dimension_value ( p_oracle_segment => 'SEGMENT4'
                             ...
                             ajc_bc_atis_batch_interface_pk.get_dimension_value ( p_oracle_segment => 'SEGMENT5'
    ...
    SELECT *
      ...
      FROM ( SELECT company,
           ...
           WHERE NOT EXISTS ( SELECT 1 
                                ...
                                FROM ajc_bc_gl_balances_ytd bc 
  ...
  BEGIN
    ...
    print_log ('ajc_bc_gl_balances_pkg.year_to_date_ytd (+)' );
    ...
    ajc_bc_account_dim_pkg.caller_p ( p_bc_environment => p_bc_environment );
    ...
    -- 20230718
      ...
      v_period_year := AJC_BC_GL_BALANCES_PKG.GET_PERIOD_YEAR ( -- 20230718 p_oracle_company,
      ...
      IF ( p_delete_final_table = 'Y' ) THEN
        ...
        print_log ('Se borra de la tabla AJC_BC_GL_BALANCES_YTD..');
      ...
      VALUES ( cytd.company,
               ...
               ajc_bc_account_dim_pkg.account_dim_required(cytd.bc_account,'COMPANY',cytd.bc_company),

               cytd.bc_account,

               ajc_bc_account_dim_pkg.account_dim_required(cytd.bc_account,'DEPARTMENT',cytd.bc_dept),

               ajc_bc_account_dim_pkg.account_dim_required(cytd.bc_account,'PRODUCT',cytd.bc_product),

               ajc_bc_account_dim_pkg.account_dim_required(cytd.bc_account,'DESTINATION',cytd.bc_dest),

               ajc_bc_account_dim_pkg.account_dim_required(cytd.bc_account,'OFFICE',cytd.bc_office),

               ajc_bc_account_dim_pkg.account_dim_required(cytd.bc_account,'ORIGIN',cytd.bc_origin),
    ...
    v_request_id_excel := print_excel_report ( p_argument1 => gv_request_id,
                                               ...
                                               p_program_short_code => 'AJCBCGLYTDR' ); -- AJC BC Master Data - GL - Year to Date - YTD - Report
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      ...
      print_log ('ajc_bc_gl_balances_pkg.year_to_date_ytd (!). Error: ' || SQLERRM );  
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      ...
      print_log ('ajc_bc_gl_balances_pkg.translated_period_net_change (!). Error: ' || SQLERRM );  
  ...
  PROCEDURE period_to_date_ptd ( retcode               OUT   NUMBER,
      ...
      FROM ( SELECT oracle_company,
                    ...
                    CASE 
                      ...
                      ELSE
                        ...
                        ajc_bc_gl_balances_pkg.translated_period_net_change ( p_set_of_books_id => set_of_books_id,
    ...
    SELECT *
     ...
     WHERE NOT EXISTS ( SELECT 1 
                          ...
                          FROM ajc_bc_gl_balances_ptd bc 
    ...
    SELECT *
     ...
     WHERE NOT EXISTS ( SELECT 1 
      ...
      SELECT ptd.oracle_account,
        ...
        FROM ajc_bc_gl_balances_ptd ptd,
  ...
  BEGIN
    ...
    print_log ('ajc_bc_gl_balances_pkg.period_to_date_ptd (+)' );
    ...
    IF ( p_delete_final_table = 'Y' ) THEN
      ...
      print_log ('Se borra de la tabla ajc_bc_gl_balances_ptd..');
    ...
    VALUES ( cptd.oracle_company,
             ...
             ajc_bc_account_dim_pkg.account_dim_required(cptd.bc_account,'COMPANY',cptd.bc_company),

             cptd.bc_account,

             ajc_bc_account_dim_pkg.account_dim_required(cptd.bc_account,'DEPARTMENT',cptd.bc_dept),

             ajc_bc_account_dim_pkg.account_dim_required(cptd.bc_account,'PRODUCT',cptd.bc_product),

             ajc_bc_account_dim_pkg.account_dim_required(cptd.bc_account,'DESTINATION',cptd.bc_dest),

             ajc_bc_account_dim_pkg.account_dim_required(cptd.bc_account,'OFFICE',cptd.bc_office),

             ajc_bc_account_dim_pkg.account_dim_required(cptd.bc_account,'ORIGIN',cptd.bc_origin),
    ...
    IF ( p_execute_report = 'Y' ) THEN
      ...
      v_request_id_excel := print_excel_report ( p_argument1 => gv_request_id,
                                                 ...
                                                 p_program_short_code => 'AJCBCGLPTDR' ); -- AJC BC Master Data - GL - Period to Date - PTD - Report
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      ...
      print_log ('ajc_bc_gl_balances_pkg.period_to_date_ptd (!). Error: ' || SQLERRM );
  ...
  BEGIN
    ...
    print_log ('ajc_bc_gl_balances_pkg.period_to_date_ptd_caller (+).' );
    ...
    -- FOR cc IN c_companies LOOP
      ...
      print_log ( 'Se borra tabla ajc_bc_gl_balances_ptd para la company ' || p_oracle_company );
      ...
      FOR cp IN c_periods LOOP
        ...
        -- Call AJC BC Master Data - GL - Period to Date - PTD
        ...
        IF v_request_id = 0 THEN
          ...
          print_log('Error Ejecutando FND_REQUEST.SUBMIT_REQUEST. AJCBCGLPTD - AJC BC Master Data - GL - Period to Date - PTD. Error: ' || v_message || ', ' || SQLERRM);
        ...
        IF NOT fnd_concurrent.wait_for_request ( v_request_id,
          ...
          print_log('Error Ejecutando FND_REQUEST.WAIT_FOR_REQUEST. AJCBCGLPTD - AJC BC Master Data - GL - Period to Date - PTD, con nro. solicitud ' || 
        ...
        IF v_conc_dev_phase != 'COMPLETE' OR v_conc_dev_status != 'NORMAL' THEN
          ...
          print_log('Error en la ejecucion del concurrente AJCBCGLPTD - AJC BC Master Data - GL - Period to Date - PTD, con nro. solicitud ' || 
    ...
    v_request_id_excel := print_excel_report ( p_argument1 => p_oracle_company,
                                               ...
                                               p_program_short_code => 'AJCBCGLPTDCR' ); -- AJC BC Master Data - GL - PTD by Company - Report
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      ...
      print_log ('ajc_bc_gl_balances_pkg.period_to_date_ptd_caller (!). Error: ' || SQLERRM );      
