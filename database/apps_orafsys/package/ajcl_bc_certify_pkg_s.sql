CREATE OR REPLACE PACKAGE              ajcl_bc_certify_pkg AS
  ...
  gv_bc_ifc_ftp             VARCHAR2(200) := 'AJCL BC Certify FTP';

  gv_bc_ifc_loader        VARCHAR2(200) := 'AJCL BC Certify Loader';
  ...
  PROCEDURE ajcl_del_expense_rpt_files ( p_status   OUT   VARCHAR2 );
  ...
  PROCEDURE main_p (p_bc_environment   IN   VARCHAR2,
                                ...
                                p_execute_ftp_loader IN VARCHAR2 );
