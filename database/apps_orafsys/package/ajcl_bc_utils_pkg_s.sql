CREATE OR REPLACE PACKAGE ajcl_bc_utils_pkg IS
...
-- Creation: SBANCHIERI 23-AUG-2023 
  ...
  -- Envia mails con attach con TO y CC, pero no funciona en gmail porque gmail rechaza cuando hay mas de un CC

  -- Se reemplaza por el de abajo
  ...
  */
  ...
  -- Inserta en la tabla AJCL_BC_LOGS
  ...
  FUNCTION get_executable_file_name_f ( p_code   IN   VARCHAR2 ) RETURN VARCHAR2;
