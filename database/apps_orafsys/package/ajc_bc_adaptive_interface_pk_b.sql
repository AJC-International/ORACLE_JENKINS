CREATE OR REPLACE PACKAGE BODY              AJC_BC_ADAPTIVE_INTERFACE_PK IS
                ...
                BEGIN
                   ...
                   print_log('after post'||' - '||to_char(sysdate,'hh24:mi:ss'));
                    ...
                    ELSE -- post ok
                            ...
                            set parent_request_id = request_id--last_update_login=g_login_id--request_id=g_conc_request_id
...
BEGIN
  ...
  print_log ('AJC_BC_ADAPTIVE_INTERFACE_PK.process_accounts (+)');
...
WHEN OTHERS THEN
    ...
    p_error_message := 'Error no tratado en AJC_BC_ADAPTIVE_INTERFACE_PK.process_accounts: ' || sqlerrm;
...
BEGIN
  ...
  print_log ('AJC_BC_ADAPTIVE_INTERFACE_PK.process_period_rates (+)');
  ...
  p_status_code := null;
        ...
        ajc_bc_ws_utils_pkg.get_bc_company_id_f(5244,NULL,NULL,v_company_id,v_status);        
        ...
        v_url := ajc_bc_ws_utils_pkg.get_base_inecta_url_f ( gv_environment, v_company_id ) || v_api_st;
...
WHEN OTHERS THEN
    ...
    p_error_message := 'Error no tratado en AJC_BC_ADAPTIVE_INTERFACE_PK.process_period_rates: ' || sqlerrm;
...
BEGIN
  ...
  print_log ('AJC_BC_ADAPTIVE_INTERFACE_PK.process_period_avg_rates (+)');
  ...
  p_status_code := null;
   ...
   v_api := ajc_bc_ws_utils_pkg.get_api_f ( p_entity => 'TRANSLATION RATES',
  ...
  v_url := ajc_bc_ws_utils_pkg.get_base_ajc_url_v2_f ( p_environment => gv_environment,
        ...
        FOR r_periods in c_periods (v_clob_result) LOOP
            ...
            IF v_count > 0 THEN -- existe, entonces update
                ...
                SET 
                    ...
                    parent_request_id=g_conc_request_id
...
BEGIN
  ...
  print_log ('AJC_BC_ADAPTIVE_INTERFACE_PK.process_origins (+)');
...
WHEN OTHERS THEN
    ...
    p_error_message := 'Error no tratado en AJC_BC_ADAPTIVE_INTERFACE_PK.process_origins: ' || sqlerrm;
...
BEGIN
  ...
  print_log ('AJC_BC_ADAPTIVE_INTERFACE_PK.process_products (+)');
...
WHEN OTHERS THEN
    ...
    p_error_message := 'Error no tratado en AJC_BC_ADAPTIVE_INTERFACE_PK.process_products: ' || sqlerrm;
...
+=========================================================================*/
  ...
  PROCEDURE main_process ( retcode                 OUT   NUMBER
                          ...
                          ,p_force_closed_periods   IN   VARCHAR2 DEFAULT 'N' ) IS
    ...
    SELECT DISTINCT bc_company_name,bc_company_id 

    FROM ajc.ajc_bc_companies;

    --WHERE bc_company_name='FOODS-CHN-CNY';
  ...
  BEGIN
    ...
    print_log ('AJC_BC_ADAPTIVE_INTERFACE_PK.main_process (+)');
    ...
    FOR r_bc_companies IN c_bc_companies LOOP
        ...
        BEGIN
                ...
                print_log('BC Company: '||r_bc_companies.bc_company_name);
