CREATE OR REPLACE PACKAGE BODY ajc_bc_ws_utils_pkg AS
  ...
  BEGIN
    ...
    -- print_log ( 'ajc_bc_ws_utils_pkg.run_job_queue_token_v2_f (+)');



    v_api := ajc_bc_ws_utils_pkg.get_api_f ( p_entity => 'JOB QUEUE',
  ...
  BEGIN
    ...
    print_log ( 'ajc_bc_ws_utils_pkg.run_job_queue_f (+)');
  ...
  BEGIN
    ...
    -- print_log ( 'ajc_bc_ws_utils_pkg.get_bc_clob_result_f (+)');
  ...
  BEGIN
    ...
    -- print_log ( 'ajc_bc_ws_utils_pkg.patch_post_bc_row_f (+)');
  ...
  BEGIN
    ...
    -- print_log ( 'ajc_bc_ws_utils_pkg.patch_post_bc_row_job_f (+)');
  ...
  BEGIN
    ...
    -- print_log ( 'ajc_bc_ws_utils_pkg.delete_bc_row_f (+)');
  ...
  BEGIN
    ...
    print_log ( 'ajc_bc_ws_utils_pkg.get_ifc_last_processed_date_f (+)');
  ...
  BEGIN
    ...
    print_log ( 'ajc_bc_ws_utils_pkg.upd_ifc_last_processed_date_p (+)');
