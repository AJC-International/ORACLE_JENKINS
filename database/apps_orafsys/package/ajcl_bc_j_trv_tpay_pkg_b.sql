CREATE OR REPLACE PACKAGE BODY              ajcl_bc_j_trv_tpay_pkg AS
...
--                   ; 
      ...
      print_log ( 'v_get_url: ' || v_get_url );
        ...
        LOOP
            ...
            v_clob_int := ajcl_bc_ws_utils_pkg.get_bc_clob_result_f ( p_url => v_get_url) ;
            ...
            WHERE requestID=TO_CHAR(cc.request_id)--TO_CHAR(gv_request_id)
