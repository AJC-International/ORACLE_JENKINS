CREATE OR REPLACE PACKAGE ajcl_bc_trv_carriers_pkg IS
...
-- Creation: SBANCHIERI 23-AUG-2023 
  ...
  gv_bc_ifc                 VARCHAR2(200) := 'AJCL BC TRV Carriers Interface';

  gv_report_filename        VARCHAR2(100) := 'AJCLBCTRVCIR';
